    ...
    <main className="min-h-screen bg-white">
      ...
      <section id="top" className="relative overflow-hidden">
        ...
        >
          ...
          <motion.div variants={item} className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: "✨", t: "Результат", d: "Первые изменения заметны после 4–6 тренировок" },
              { icon: "🚿", t: "Комфорт", d: "Индивидуальная раздевалка, полотенца, напитки и все нобходимые гигенические средства" },
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 md:px-6">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-4">
          ...
          <StatCard icon="📉" value="минус 6 кг" label="в среднем за месяц" />
          <StatCard icon="📏" value="минус 8 см" label="уходит по объёмам за месяц" />
        </div>
          ...
          <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="mt-6 text-sm text-white/70">
                Адрес: Москва, район Коммунарка, бульвар Веласкеса, 4
              </div>
            </div>
